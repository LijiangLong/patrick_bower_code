...
class PrepPreparer:
	...
	def validateInputData(self):
		assert os.path.exists(self.projFileManager.localFirstFrame)
		assert os.path.exists(self.projFileManager.localLastFrame)
		assert os.path.exists(self.projFileManager.localDepthRGB)
		assert os.path.exists(self.projFileManager.localDepthRGB)
